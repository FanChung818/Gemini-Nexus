...
export const DEFAULT_STORED_GEMINI_MODEL = 'gemini-2.5-flash';
export const DEFAULT_OFFICIAL_MODEL = 'gemini-3-flash-preview';
export const DEFAULT_OFFICIAL_MODELS = 'gemini-3-flash-preview, gemini-3-pro-preview';
...
export const DEFAULT_MCP_SERVER_URL = 'http://127.0.0.1:3006/sse';
