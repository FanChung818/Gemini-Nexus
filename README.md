...
这是基于原项目 [yeahhe365/gemini-nexus](https://github.com/yeahhe365/gemini-nexus) 的二次开发版本。当前二开版本的应用内源码链接、版本检查与 Releases 指向 [Maomaoxion/gemini-nexus](https://github.com/Maomaoxion/gemini-nexus)。
...
- 新增 **Gemini API Google Search grounding** 支持，并在回复中展示联网来源。
