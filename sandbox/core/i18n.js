...
export const translations = {
    en: {
        ...
        openaiUseResponsesApiDesc: 'When disabled, OpenAI Compatible API uses Chat Completions.',
        openaiWebSearch: 'Enable OpenAI API web search',
        openaiWebSearchDesc:
            'Uses the selected API interface: Responses web_search or Chat Completions web_search_options. Not every compatible endpoint supports this.',
        modelIds: 'Model IDs',
        officialModelPlaceholder: 'e.g. gemini-3-flash-preview, gemini-3-pro-preview',
    ...
    zh: {
        ...
        openaiUseResponsesApiDesc: '关闭时，OpenAI 兼容 API 使用 Chat Completions。',
        openaiWebSearch: '启用 OpenAI API 联网搜索',
        openaiWebSearchDesc:
            '按当前接口发送联网参数：Responses web_search 或 Chat Completions web_search_options。并非所有兼容接口都支持。',
        modelIds: '模型 IDs',
        officialModelPlaceholder: '例如 gemini-3-flash-preview, gemini-3-pro-preview',
        sourcesLabel: '来源',
