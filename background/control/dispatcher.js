...
export class ToolDispatcher {
    ...
    async dispatch(name, args) {
        switch (name) {
            ...
            case 'drag_element':
                return this.actions.dragElement(args);
            case 'hover':
                return this.actions.hoverElement(args);
            case 'fill':
                return this.actions.fillElement(args);
            case 'fill_form':
                return this.actions.fillForm(args);
            case 'press_key':
            ...
            case 'take_screenshot':
                return this.actions.takeScreenshot(args);
            case 'take_snapshot':
                return this.snapshotManager.takeSnapshot(args);
            case 'wait_for':
                return this.actions.waitFor(args);
            ...
            // Emulation
            case 'emulate':
                return this.actions.emulate(args);
            case 'resize_page':
                return this.actions.resizePage(args);
            ...
            // Observability / Network
            case 'get_logs':
                return this.actions.observation.getLogs();
            case 'get_network_activity':
                return this.actions.observation.getNetworkActivity();
            case 'list_network_requests':
                return this.actions.observation.listNetworkRequests(args);
            case 'get_network_request':
                return this.actions.observation.getNetworkRequest(args);
